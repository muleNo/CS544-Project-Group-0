...
public class EmailTemplate {
    public  String courseRegistration(NotificationRequest req ) {
        ...
        return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "<div>\n" +
                "<div>\n" +
                "<div><strong> "+ req.getStudentName()+  " Course Registration </strong></div>\n" +
                "</div>\n" +
                "</div>\n" +
                "</div>\n" +
                "</div>\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 18px; line-height: 34.2px;\"><strong><span style=\"line-height: 34.2px; font-size: 18px;\">Dear  "+ req.getStudentEmail()+",</span></strong></span></p>\n" +
                "<p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 16px; line-height: 30.4px;\">"+req.getProfessorName() +" is your professor for course "+ req.getCourseName() + "\n</span></p>\n" +
                "<div><strong>EA PROJECT  Management </strong></div>\n"+
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
